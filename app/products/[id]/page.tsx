    ...
    <div className='product-container'>
          ...
          <div className='product-info'>
            <div className='flex flex-col gap-2'>
              <p className='text-[34px] text-secondary font-bold'>
                {product.currencySymbol}{product.currentPrice}
              </p>
            ...
            <div className='flex flex-col gap-4'>
              <div className='flex gap-3'>
                ...
                <div className='product-reviews'>
                  <Image 
                    src='/assets/icons/comment.svg' alt='comment'
                    width={16} height={16}
                  />
          ...
          <div className='my-7 flex flex-col gap-5'>
            <div className='flex flex-wrap gap-5'>
              <PriceInfoCard 
                ...
                value={`${product.currencySymbol} ${product.currentPrice}`}
              />
              <PriceInfoCard 
                title='Average Price'
                iconSrc='/assets/icons/chart.svg'
                value={`${product.currencySymbol} ${product.averagePrice}`}
              />
              <PriceInfoCard 
                title='Lowest Price'
                iconSrc='/assets/icons/arrow-down.svg'
                value={`${product.currencySymbol} ${product.lowestPrice}`}
              />
              <PriceInfoCard 
                title='Highest Price'
                iconSrc='/assets/icons/arrow-up.svg'
                value={`${product.currencySymbol} ${product.highestPrice}`}
              />
            </div>
          </div>
      ...
      <div className='flex flex-col gap-16'>
        ...
        <button className='btn w-fit mx-auto flex items-center justify-center gap-3 min-w-[200px]'>
          <Image 
            src='/assets/icons/bag.svg' alt='check'
            width={22} height={22}
          />
